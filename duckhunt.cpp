...
struct Game {
    ...
    Game()
    {
        ...
        box[4].width = 45;
        box[4].height = 35;
        box[4].center.x = (WINDOW_WIDTH / 10) - (WINDOW_WIDTH / 70);
        box[4].center.y = WINDOW_HEIGHT - (WINDOW_HEIGHT - floor) - (floor / 1.5);
        box[4].center.z = 0;
...
//--------------------------------------------
    glGenTextures(1, &menuTexture);//menu splashscreen
//------------------------------------------
...
//-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    //Drawing 3 Boxes over background
    Shape *s;
...
//-----------------------------------------------------------------------------------------------------------------------------------------
        ...
        //}
            ...
            //du/checkck_sprite.pos[0] = s->center.x;
